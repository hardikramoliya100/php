...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="getajex">
                    <i class="fas fa-fw fa-table"></i>
                    <span>ajex data</span></a>
            </li>
            <li class="nav-item">
    ...
    <script src="<?php echo $Baseurl[0]."//".$Baseurl[2]; ?>/vendor/jquery/jquery.min.js"></script>
    <script src="<?php echo $Baseurl[0]."//".$Baseurl[2]; ?>/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?php echo $Baseurl[0]."//".$Baseurl[2]; ?>/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="<?php echo $Baseurl[0]."//".$Baseurl[2]; ?>/vendor/chart.js/Chart.min.js"></script>
